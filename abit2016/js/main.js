...
var specialKeys = ["гайд", "про бали зно", "хелоу", "сикорский", "стоит ли вообще поступать в кпи", "сколько балов нужно на бюджет", "шампунь для мужиков"];
...
function displaySpecial(key) {
    ...
    var map = {
        ...
        "шампунь для мужиков": "plotva.html"
    };
