...
function search(text) {
    ...
    mainLoop:
        for (var i in people) {
            ...
            personRaw += (person.course == null ? "Випускник закончил" : person.course + " курс рік год") + " ";
            personRaw += (person.hostel == null ? "Київ киевский Киев" : person.hostel + " гуртожиток общага общежитие");
    ...
    for (var i = 0; i < faculty.ways.length; i += 3) {
        ...
        for (var j = 0; j < 3 && i + j < faculty.ways.length; j++) {
            ...
            info += "<div class=\"col-xs-4 way\">" +
                ...
                "<div class=\"progress-bar\" style=\"width: " + item["score-14"] + "\"></div>" +
                "</div>" +
                "<span class=\"progress-label-r\">" + item["score-13"] + "</span>" +
                "<span class=\"progress-label-l\">2013</span>" +
                "<div class=\"progress progress-striped\">" +
                "<div class=\"progress-bar progress-bar-success\" style=\"width: " + item["score-13"] + "\"></div>" +
                "</div>" +
                "<span class=\"progress-label-r\">" + item["score-12"] + "</span>" +
                "<span class=\"progress-label-l\">2012</span>" +
                "<div class=\"progress progress-striped\">" +
                "<div class=\"progress-bar progress-bar-warning\" style=\"width: " + item["score-12"] + "\"></div>" +
                "</div>" +
                "</div>" +
                "</div>";
        }
